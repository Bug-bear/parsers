...
%  Auto-generated by MATLAB on 04-Sep-2012 17:59:52
...
% Create plot
plot1 = plot(Y1,'Parent',axes1,'DisplayName','Noise Sample Sequence');
%plot1 = plot(Y1,'Parent',axes1,'DisplayName','Trend Component');
...
% Plot the fit
fitLine1 = plot(xplot1,yplot1,'DisplayName','   Linear Trend','Parent',axes1,...
    'Tag','linear',...
    'Color',[1 0 0]);
